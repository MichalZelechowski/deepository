 ...
 ***************************************************************************** */
package org.mz.deepository.lego.color.transfer;
...
/**
 * Neural Style Transfer Algorithm References https://arxiv.org/pdf/1508.06576.pdf https://arxiv.org/pdf/1603.08155.pdf
...
public class NeuralStyleTransfer {
    ...
    /**
     * Values suggested by https://harishnarayanan.org/writing/artistic-style-transfer/ Other Values(5,100):
...
//    private static final String OUTPUT_NAME = "iteration";
    private static final String CONTENT_FILE = "/styletransfer/castle.jpg";
    private static final String STYLE_FILE = "/styletransfer/bricks_style.jpg";
    private static final String OUTPUT_PATH = "/styletransfer/out/";
    private static final String OUTPUT_NAME = "iteration_lego";
    ...
    private INDArray backPropagateStyles(ComputationGraph vgg16FineTune, HashMap<String, INDArray> activationsStyleGramMap,
    ...
    private INDArray backPropagateContent(ComputationGraph vgg16FineTune, Map<String, INDArray> activationsContentMap,
            Map<String, INDArray> activationsCombMap) {
    ...
    private double totalLoss(Map<String, INDArray> activationsStyleMap, Map<String, INDArray> activationsCombMap,
    ...
    /**
     * After passing in the content, style, and combination images, compute the loss with respect to the content. Based off of:
     * https://harishnarayanan.org/writing/artistic-style-transfer/
     *
    ...
    /**
     * This method is simply called style_loss in https://harishnarayanan.org/writing/artistic-style-transfer/ but it takes inputs for intermediate
     * activations from a particular layer, hence my re-name. These values contribute to the total style loss.
     *
    ...
    /**
     * Element-wise differences are squared, and then summed. This is modelled after the content_loss method defined in
     * https://harishnarayanan.org/writing/artistic-style-transfer/
     *
     * @param a One tensor
    ...
    /**
     * Equation (2) from the Gatys et all paper: https://arxiv.org/pdf/1508.06576.pdf This is the derivative of the content loss w.r.t. the combo
     * image features within a specific layer of the CNN.
     *
    ...
    /**
     * Computing the Gram matrix as described here: https://harishnarayanan.org/writing/artistic-style-transfer/ Permuting dimensions is not needed
     * because DL4J stores the channel at the front rather than the end of the tensor. Basically, each tensor is flattened into a vector so that the
    ...
    /**
     * Equation (6) from the Gatys et all paper: https://arxiv.org/pdf/1508.06576.pdf This is the derivative of the style error for a single layer
     * w.r.t. the combo image features at that layer.
     *
    ...
    private void saveImage(INDArray combination, int iteration) throws IOException {
        ...
        File file = new File(resource.getPath() + "/" + OUTPUT_NAME + String.format("%03d", iteration) + ".jpg");
        ImageIO.write(output, "jpg", file);
    }

    /**
     * Takes an INDArray containing an image loaded using the native image loader libraries associated with DL4J, and converts it into a
     * BufferedImage. The INDArray contains the color values split up across three channels (RGB) and in the integer range 0-255.
     *
